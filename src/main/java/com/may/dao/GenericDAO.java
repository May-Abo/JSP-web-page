...
/**
 * @see https://docs.oracle.com/javaee/7/api/javax/persistence/EntityManager.html
 * @author mayab
 * @param <T> 
 */
public abstract class GenericDAO<T> {
    ...
    /**
     * commit changes and then close the transaction. same as calling commit and
     * closeTransaction
     */
    ...
    /**
     * save this entity as persistence object which means the entity manager
     * will track it.
     *
     ...
     * @param parameters - parameters to be set in named query, a map of keys
     * (name place holder in named query) and value (value to replace the place
     * holder in named query)
     * @return one result
     */
     ...
     * or queries that are defined in metadata by using the javax.persistence.NamedQuery annotation.
